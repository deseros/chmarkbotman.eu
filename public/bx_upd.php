...
### CONFIG OF BOT ###
#####################
define( 'DEBUG_FILE_NAME', 'log_openline_macardv7' );
// if you need read debug log, you should write unique log name
define( 'CLIENT_ID', 'local.57062d3061fc71.97850406' );
// like 'app.67efrrt2990977.85678329' or 'local.57062d3061fc71.97850406' - This code should take in a partner's site, needed only if you want to write a message from Bot at any time without initialization by the user
...
// receive event 'Application install'
    ...
    writeToLog( $handlerBackUrl, 'Ссылка handlerBackUrl' );
    // Запись в лог получившейся ссылки
    ...
    $botId = $result[ 'result' ];
    //сохраняем идентификатор бота в переменную botId
